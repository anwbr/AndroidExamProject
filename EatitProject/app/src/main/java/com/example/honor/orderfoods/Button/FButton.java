package com.example.honor.orderfoods.Button;

/**
 * Created by honor on 12/24/2017.
 */
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            if (attr == R.styleable.FButton_shadowEnabled) {
                ...
                mButtonColor = typedArray.getColor(attr, getResources().getColor(R.color.fbutton_default_shadow_color));
